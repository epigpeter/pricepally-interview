            ...
            <div class="col-lg-4">
                ...
                <ul class="list-unstyled social-icons">
                    <li class="d-inline-block">
                        <a href="#">
                            <embed src="{{asset('assets')}}/images/facebook.svg" width="25px">
                        </a>
                        <a href="#">
                            <embed src="{{asset('assets')}}/images/instagram.svg" width="25px">
                        </a>
                        <a href="#">
                            <embed src="{{asset('assets')}}/images/twitter.svg" width="25px">
                        </a>
                        <a href="#">
                            <embed src="{{asset('assets')}}/images/youtube.svg" width="25px">
                        </a>
                    </li>
                </ul>
            </div>
