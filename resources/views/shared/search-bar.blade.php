                 ...
                 <div class="tab-content" id="deliveryTabContent">
                     <div class="tab-pane fade show active Mobfood-tab mobile-search-food" id="Mobfood-tab"
                         ...
                         <div class="d-flex mb-3">
                             <div class="justify-content-start pr-2">
                                 <img class="search-img" src="{{asset('assets')}}/images/search-img1.jpg" alt="search-img1">
                         ...
                         <div class="d-flex mb-3">
                             <div class="justify-content-start pr-2">
                                 <img class="search-img" src="{{asset('assets')}}/images/search-img2.jpg" alt="search-img1">
                     ...
                     <div class="tab-pane fade payment-bg" id="users" role="tabpanel" aria-labelledby="Mobuser-tab">
                         ...
                         <div class="d-flex align-content-between flex-wrap myfollowers mb-4">
                             <div class="p-2"><img class="follow-img" src="{{asset('assets')}}/images/followers1.jpg"
