                ...
                <div class="hero-content text-center">
                    <a href="refer_earn.html">
                        <div class="box-outline refer-bg">
                            ...
                            <div class="home-list-img">
                                <img src="{{asset('assets')}}/images/refer-money.svg">
                            </div>
                        </div>
                    </a>
                    <a href="make_list.html">
                        <div class="box-outline mt-4 list-make-bg">
                            ...
                            <p>Shop faster now</p>
                            <div class="home-list-img">
                                <img src="{{asset('assets')}}/images/list.svg">
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div id="hero-sliderSlidesOnly" class="carousel slide home_slider" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{asset('assets')}}/images/slider1.jpg" alt="slider1.jpg">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{asset('assets')}}/images/slider2.jpg" alt="slider2.jpg">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{asset('assets')}}/images/slider1.jpg" alt="slider1.jpg">
                        </div>
